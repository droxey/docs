...
- [docs.outputs.io](docs/home.md#docsoutputsio)
  ...
  * [Contributions](docs/home.md#contributions)
...
- [Git Workflow: Feature Branches](docs/tools/git/feature-branches.md#git-workflow-feature-branches)
  ...
  * [Command Overview](docs/tools/git/feature-branches.md#command-overview)
  * [Step by Step](docs/tools/git/feature-branches.md#step-by-step)
    + [Step 1](docs/tools/git/feature-branches.md#step-1)
    + [Step 2](docs/tools/git/feature-branches.md#step-2)
    + [Step 3](docs/tools/git/feature-branches.md#step-3)
    + [Step 4](docs/tools/git/feature-branches.md#step-4)
    + [Step 5](docs/tools/git/feature-branches.md#step-5)
    + [Step 6](docs/tools/git/feature-branches.md#step-6)
...
- [Source Control: How I Learned to Stop Worrying, and Love Git](docs/tools/git/setup.md#source-control-how-i-learned-to-stop-worrying-and-love-git)
  ...
  * [Intro to Git: Warmup Activity (15 Minutes)](docs/tools/git/setup.md#intro-to-git-warmup-activity-15-minutes)
  * [Installing Git](docs/tools/git/setup.md#installing-git)
    + [macOS](docs/tools/git/setup.md#macos)
    + [Windows 10](docs/tools/git/setup.md#windows-10)
    + [Linux](docs/tools/git/setup.md#linux)
      - [Debian/Ubuntu:](docs/tools/git/setup.md#debianubuntu)
      - [Red Hat/CentOS:](docs/tools/git/setup.md#red-hatcentos)
  * [Verifying Your Installation](docs/tools/git/setup.md#verifying-your-installation)
  * [Configuring Git](docs/tools/git/setup.md#configuring-git)
  * [Generating and Configuring SSH Keys](docs/tools/git/setup.md#generating-and-configuring-ssh-keys)
  * [Cloning a Remote Repository to Your Local Machine](docs/tools/git/setup.md#cloning-a-remote-repository-to-your-local-machine)
  * [Updating Your Local Repository When New Content is Available](docs/tools/git/setup.md#updating-your-local-repository-when-new-content-is-available)
  * [Adding, Committing, and Pushing Local Changes to Remote Repositories](docs/tools/git/setup.md#adding-committing-and-pushing-local-changes-to-remote-repositories)
  * [Get Advanced with Git](docs/tools/git/setup.md#get-advanced-with-git)
  * [More Practice/Additional Educational Resources](docs/tools/git/setup.md#more-practiceadditional-educational-resources)
    + [Fundamentals](docs/tools/git/setup.md#fundamentals)
    + [eBooks](docs/tools/git/setup.md#ebooks)
    + [Videos](docs/tools/git/setup.md#videos)
    + [GitHub](docs/tools/git/setup.md#github)
    + [GUIs](docs/tools/git/setup.md#guis)
      - [Free](docs/tools/git/setup.md#free)
