...
- [Windows Configuration Tips and Tricks](./tools/git/common-issues.md#windows-configuration-tips-and-tricks)
  * [Git Bash](./tools/git/common-issues.md#git-bash)

### [feature-branches](./tools/git/feature-branches.md)

- [Git Workflow: Feature Branches](./tools/git/feature-branches.md#git-workflow-feature-branches)
    + [Successful teams follow 3 easy rules to integrate git into their daily workflow:](./tools/git/feature-branches.md#successful-teams-follow-3-easy-rules-to-integrate-git-into-their-daily-workflow)
  * [Command Overview](./tools/git/feature-branches.md#command-overview)
  * [Step by Step](./tools/git/feature-branches.md#step-by-step)
    + [Step 1](./tools/git/feature-branches.md#step-1)
    + [Step 2](./tools/git/feature-branches.md#step-2)
    + [Step 3](./tools/git/feature-branches.md#step-3)
    + [Step 4](./tools/git/feature-branches.md#step-4)
    + [Step 5](./tools/git/feature-branches.md#step-5)
    + [Step 6](./tools/git/feature-branches.md#step-6)
    + [Step 7](./tools/git/feature-branches.md#step-7)
  * [IMPORTANT!](./tools/git/feature-branches.md#important)
...
### [keybase-gitcrypt](./tools/git/keybase-gitcrypt.md)

- [Keybase + Git Crypt](./tools/git/keybase-gitcrypt.md#keybase--git-crypt)

### [setup](./tools/git/setup.md)

- [Source Control: How I Learned to Stop Worrying, and Love Git](./tools/git/setup.md#source-control-how-i-learned-to-stop-worrying-and-love-git)
  * [Objectives](./tools/git/setup.md#objectives)
  * [Intro to Git: Warmup Activity (15 Minutes)](./tools/git/setup.md#intro-to-git-warmup-activity-15-minutes)
  * [Installing Git](./tools/git/setup.md#installing-git)
    + [macOS](./tools/git/setup.md#macos)
    + [Windows 10](./tools/git/setup.md#windows-10)
    + [Linux](./tools/git/setup.md#linux)
      - [Debian/Ubuntu:](./tools/git/setup.md#debianubuntu)
      - [Red Hat/CentOS:](./tools/git/setup.md#red-hatcentos)
  * [Verifying Your Installation](./tools/git/setup.md#verifying-your-installation)
  * [Configuring Git](./tools/git/setup.md#configuring-git)
  * [Generating and Configuring SSH Keys](./tools/git/setup.md#generating-and-configuring-ssh-keys)
  * [Cloning a Remote Repository to Your Local Machine](./tools/git/setup.md#cloning-a-remote-repository-to-your-local-machine)
  * [Updating Your Local Repository When New Content is Available](./tools/git/setup.md#updating-your-local-repository-when-new-content-is-available)
  * [Adding, Committing, and Pushing Local Changes to Remote Repositories](./tools/git/setup.md#adding-committing-and-pushing-local-changes-to-remote-repositories)
  * [Get Advanced with Git](./tools/git/setup.md#get-advanced-with-git)
  * [More Practice/Additional Educational Resources](./tools/git/setup.md#more-practiceadditional-educational-resources)
    + [Fundamentals](./tools/git/setup.md#fundamentals)
    + [eBooks](./tools/git/setup.md#ebooks)
    + [Videos](./tools/git/setup.md#videos)
    + [GitHub](./tools/git/setup.md#github)
    + [GUIs](./tools/git/setup.md#guis)
      - [Free](./tools/git/setup.md#free)
      - [Paid](./tools/git/setup.md#paid)
    + [Repositories of Note](./tools/git/setup.md#repositories-of-note)

### [submitting-homework](./tools/git/submitting-homework.md)

- [Submitting Homework on GitHub](./tools/git/submitting-homework.md#submitting-homework-on-github)
  * [Prerequisites](./tools/git/submitting-homework.md#prerequisites)
  * [Step by Step](./tools/git/submitting-homework.md#step-by-step)
