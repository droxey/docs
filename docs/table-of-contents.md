...
- [Lesson Plan - Callbacks](code/js/callbacks.md#lesson-plan---callbacks)
  ...
  * [[7:00] Callbacks: Theory and Implementation](code/js/callbacks.md#700-callbacks-theory-and-implementation)
    + [[1:15] Variables vs Functions](code/js/callbacks.md#115-variables-vs-functions)
    + [[1:00] Introducing Callbacks](code/js/callbacks.md#100-introducing-callbacks)
    + [[4:00] Live Code: Simple Callback](code/js/callbacks.md#400-live-code-simple-callback)
    + [[0:45] Recap](code/js/callbacks.md#045-recap)
...
- [Your Node.js authentication tutorial is (probably) wrong](ext/ext-node-auth-tutorial-is-probably-wrong.md#your-nodejs-authentication-tutorial-is-probably-wrong)
    ...
    + [Mistake three: API tokens](ext/ext-node-auth-tutorial-is-probably-wrong.md#mistake-three-api-tokens)
    + [Mistake four: rate limiting](ext/ext-node-auth-tutorial-is-probably-wrong.md#mistake-four-rate-limiting)
...
- [Setup dev image](ext/ext-node-docker-local-dev.md#setup-dev-image)
  * [Using the dev image](ext/ext-node-docker-local-dev.md#using-the-dev-image)
  * [Listening for changes](ext/ext-node-docker-local-dev.md#listening-for-changes)
  * [Opening ports](ext/ext-node-docker-local-dev.md#opening-ports)
...
- [3D Printed WiFi Access QR Codes: Part 1](ext/ext-python-3d-printed-qr-codes-python.md#3d-printed-wifi-access-qr-codes-part-1)
    ...
    + [Getting Set Up](ext/ext-python-3d-printed-qr-codes-python.md#getting-set-up)
    + [Step 1: Encoding WiFi credentials in a QR code](ext/ext-python-3d-printed-qr-codes-python.md#step-1-encoding-wifi-credentials-in-a-qr-code)
    + [Step 2: 3D Printing a QR Code](ext/ext-python-3d-printed-qr-codes-python.md#step-2-3d-printing-a-qr-code)
      - [Create Text Representation](ext/ext-python-3d-printed-qr-codes-python.md#create-text-representation)
      - [Create Array Representation](ext/ext-python-3d-printed-qr-codes-python.md#create-array-representation)
...
- [Python Pandas: Tricks & Features You May Not Know](ext/ext-python-pandas-tricks.md#python-pandas-tricks--features-you-may-not-know)
  ...
  * [6. Introspect Groupby Objects via Iteration](ext/ext-python-pandas-tricks.md#6-introspect-groupby-objects-via-iteration)
  * [7. Use This Mapping Trick for Membership Binning](ext/ext-python-pandas-tricks.md#7-use-this-mapping-trick-for-membership-binning)
  * [8. Understand How Pandas Uses Boolean Operators](ext/ext-python-pandas-tricks.md#8-understand-how-pandas-uses-boolean-operators)
  * [9. Load Data From the Clipboard](ext/ext-python-pandas-tricks.md#9-load-data-from-the-clipboard)
...
- [Jupyter Notebook Tips and Tricks](tools/jupyter/jupyter.md#jupyter-notebook-tips-and-tricks)
  ...
  * [Change Default Browser](tools/jupyter/jupyter.md#change-default-browser)
  * [Enable PDF Generation](tools/jupyter/jupyter.md#enable-pdf-generation)
